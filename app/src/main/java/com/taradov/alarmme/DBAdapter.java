...
public class DBAdapter {
    ...
    //PatientProfile Table Constants
    ...
    public static final String KEY_PATIENT_CHILDRENNO = "ChildrenNo";
    ...
    public static final int PATIENT_CD4_COLUMN = 16;
    public static final int PATIENT_VIRALLOAD_COLUMN= 17;
    public static final int PATIENT_DIAGNOSISDATE_COLUMN = 18;

    public static final String[] ALL_PATIENT_TABLE_COLUMNS = new String[]{KEY_PATIENT_ID, KEY_PATIENT_NAME, KEY_PATIENT_FATHERNAME,
            KEY_PATIENT_AGE,KEY_PATIENT_GENDER, KEY_PATIENT_ETHNICITY, KEY_PATIENT_ADDRESS, KEY_PATIENT_MARITALSTATUS, KEY_PATIENT_PROFESSION, KEY_PATIENT_INFECTIONS,
            KEY_PATIENT_CHILDRENNO, KEY_PATIENT_CHILDRENSUFFER, KEY_PATIENT_SPOUSESUFFER, KEY_PATIENT_RISK, KEY_PATIENT_TRAVELHISTORY,
            KEY_PATIENT_FRIENDHISTORY, KEY_PATIENT_CD4, KEY_PATIENT_VIRALLOAD, KEY_PATIENT_DIAGNOSISDATE};
    ...
    public long addPatient(Patient _patient ) {
        ...
        values.put(KEY_PATIENT_CHILDRENNO       , _patient.getChlidrenno());
        values.put(KEY_PATIENT_CHILDRENSUFFER   , _patient.getChlidrenSuffer());
    ...
    public boolean updatePatient(long _id, Patient _patient) {
        ...
        newValues.put(KEY_PATIENT_CHILDRENNO       , _patient.getChlidrenno());
        newValues.put(KEY_PATIENT_CHILDRENSUFFER   , _patient.getChlidrenSuffer());
    ...
    public boolean updatePatient(String _name, Patient _patient) {
        // Create a new row of values to insert.
        ContentValues newValues = new ContentValues();
        ...
        // Insert the row.
        return db.update(PATIENT_TABLE, newValues, KEY_PATIENT_ID + "=" + _name, null) > 0;
    }
