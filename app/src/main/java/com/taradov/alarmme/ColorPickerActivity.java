...
public class ColorPickerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = (ImageView)findViewById(R.id.selected_color); colorSeekBar = (SeekBar)findViewById(R.id.color_seeker);
    ...
    private void intializeColorArray()
    {
        ...
        // 1 23 4567 89
 /*1*/ colorPickerArray.add(new ColorPicker(255,0,0,255)); colorPickerArray.add(new
 ...
 /*2*/ colorPickerArray.add(new ColorPicker(255,36,36,255)); colorPickerArray.add(new
 ...
 /*3*/ colorPickerArray.add(new ColorPicker(255,73,73,255)); colorPickerArray.add(new
 ...
 /*4*/ colorPickerArray.add(new ColorPicker(255,109,109,255));colorPickerArray.add(new
 ...
 /*5*/ colorPickerArray.add(new ColorPicker(255,146,146,255));colorPickerArray.add(new
 ...
 /*6*/ colorPickerArray.add(new ColorPicker(255,182,182,255));colorPickerArray.add(new
 ...
 /*7*/ colorPickerArray.add(new ColorPicker(255,219,219,255));colorPickerArray.add(new
