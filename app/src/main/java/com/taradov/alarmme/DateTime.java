...
public class DateTime {
    ...
    private SimpleDateFormat mEndDateFormat;
    private SimpleDateFormat mDiagnosisDateFormat;
    private SimpleDateFormat mSysDateFormat;
    ...
    public void update() {
        ...
        mSysDateFormat = new SimpleDateFormat("E MMM d, yyyy");

        mEndDateFormat = new SimpleDateFormat("E MMM d, yyyy");
        mDiagnosisDateFormat = new SimpleDateFormat("E MMM d,yyyy");
    ...
    public String formatSysDate() {
        return mSysDateFormat.format(new Date(System.currentTimeMillis()));
    }


//    public String formatDiagnosisDate(Patient pat) {
//        return mDiagnosisDateFormat.format(new Date(pat.getDiagnosisDate()));
//
//    }
